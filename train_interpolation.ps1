<#
.SYNOPSIS
    Train the KeySync interpolation model.
...
try {
    ...
    python main.py --base configs/example_training/interpolation/interpolation_dub.yaml --wandb True `
        lightning.trainer.num_nodes=1 `
        lightning.strategy=$Strategy `
        lightning.trainer.precision=32 `
        model.base_learning_rate=3.e-5 `
