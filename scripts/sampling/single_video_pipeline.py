...
def main():
    ...
    parser.add_argument("--keyframes_ckpt", default="pretrained_models/checkpoints/keyframes_dub.ckpt")
    parser.add_argument("--interpolation_ckpt", default="pretrained_models/checkpoints/interpolation_dub.ckpt")
